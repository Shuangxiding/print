<template>
  <el-col>
    ...
    <el-table :data="params" header-align="center" max-height="500" border class="no-padding-cell" :max-height="200">
      ...
      <el-table-column prop="phone" label="联系电话" align="center" colSpan="3" min-width="100">
      </el-table-column>
      <el-table-column prop="phoneStatus" label="电话状态" align="center" min-width="80">
        <template scope="scope">
...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       */
      getName() {
        return this.changePhoneNum.name
      },
      /**
       * 修改列表中联系电话
       */
