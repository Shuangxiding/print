<template>
  <el-col>
    ...
    <el-table :data="params" header-align="center" max-height="500" border class="no-padding-cell">
      ...
      <el-table-column prop="relation" label="关系" align="center" min-width="60">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      refresh() {
        this.params = this.$store.state.accManage.cust_info.customerContacts.map(v => Object.assign({}, v))
      }
    },
    mounted() {
      net.send({
        server: servers.AccManage.get_message_model_info,
        data: {
          style: '29'
        }
      }).then((data) => {
