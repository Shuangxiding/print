...
<template>
  <div class="page">
    <data-box ref="databox" :params="params" :defaultParams="defaultParams" :server="servers.client" row-key="orapId">
      <!--输入区域START-->
      <template slot="input">
        <el-form-item label="委托方:" v-role="0x050202">
        ...
        <el-form-item label="客户姓名:" v-role="0x050203">
          <el-input v-model="params.reapCust"></el-input>
        </el-form-item>
        <el-form-item label="申请省份:" v-role="0x050204">
        ...
        <el-form-item label="申请日期" v-role="0x050205">
          <el-date-picker v-model="params.createTimeBegin" type="date" placeholder="选择日期" :picker-options="createTimeBegin" :editable="false">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="-" v-role="0x050205">
          <el-date-picker v-model="params.createTimeEnd" type="date" placeholder="选择日期" :picker-options="createTimeEnd" :editable="false">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="案件金额" v-role="0x050206">
          <el-input v-model="params.reapAmtStart" type="number"></el-input>
        </el-form-item>
        <el-form-item label="-" v-role="0x050206">
          <el-input v-model="params.reapAmtEnd" type="number"></el-input>
        </el-form-item>
        <el-form-item label="还款状态:" v-role="0x050207">
        ...
        <el-form-item label="逾期天数 " v-role="0x050208" prop="reapOverdayStart" :rules="[
          ...
          <el-input v-model="params.reapOverdayStart" type="number"></el-input>
        </el-form-item>
        <el-form-item label="-" v-role="0x050208" prop="reapOverdayEnd" :rules="[
          ...
          <el-input v-model="params.reapOverdayEnd" type="number"></el-input>
        </el-form-item>
    ...
    <el-dialog @open='caseDetail' title="修复详情" v-model="accUserDialogsVisual" size="large">
      <template>
