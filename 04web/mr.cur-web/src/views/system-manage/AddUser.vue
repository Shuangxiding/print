<template>
  <!--新增用户-->
  <div class="page">
    <el-form :rules="rules" :model="addParams" ref="add-form" label-width="100px" align="left" v-loading="loading.state">
      <el-row>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="电话" prop="phone">
            <el-input v-model="addParams.phone" size="small" :maxlength="18"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="所属机构">
            <el-select v-model="addParams.deptId" placeholder="请选择" size="small">
        ...
        <el-col :span="12">
          <el-form-item label="催收类型" prop="degrId">
            <el-select v-model="addParams.degrId" placeholder="请选择" size="small">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="是否具有权限" min-width="140px">
            <el-select v-model="addParams.userManager" size="small">
      ...
      <el-form-item label="备注" prop="remark">
        <el-col :span="20">
          <el-input type="textarea" v-model="addParams.remark" :autosize="{ minRows:2, maxRows:4}" :maxlength="200"></el-input>
        </el-col>
      </el-form-item>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        servers: {
          userAddDepartment: server.SystemManage.add_user_department,
          addUserList: server.SystemManage.add_user
        },
        // 加载动画
        loading: {
          state: false
    ...
    methods: {
      ...
      addUserCommit() {
        ...
        this.$refs['add-form'].validate((valid) => {
          ...
          this.addParams.deptId = this.deptId
          net.send({
            server: this.servers.addUserList,
            data: this.addParams,
            loading: this.loading
          }).then((data) => {
            // 保存数据信息
            net.send({
              server: this.servers.userAddDepartment,
              data: {
                userId: data.userId,
